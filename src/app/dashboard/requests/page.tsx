      ...
      <div className="card overflow-hidden">
        {loading ? (
            ...
            <tbody>
              {filtered.map(r => (
                <tr key={r.id}>
                  ...
                  <td>
                    <span className="text-sm truncate max-w-[180px] block" style={{ color: 'var(--text-muted)' }}>
                      {r.reason || '–'}
                    </span>
                  </td>
                  <td>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 p-4">
            {filtered.map(r => (
              <div key={r.id} className="border p-4 rounded-xl flex flex-col gap-3 relative transition-all hover:shadow-md" style={{ borderColor: 'var(--border)', background: 'var(--bg-surface)' }}>
                ...
                <div className="text-xs" style={{ color: 'var(--text-muted)' }}>
                  <span className="font-semibold" style={{ color: 'var(--text-base)' }}>Grund: </span>
                  {r.reason || '–'}
                </div>
