...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    const saved =
      typeof window !== "undefined" ? localStorage.getItem("role-mode") : null;
  ...
  const approvedDaysThisYear = myRequests
    .filter(
      (r) =>
        r.status === "approved" && parseISO(r.from).getFullYear() === thisYear,
    )
    .reduce(
      (sum, r) =>
    ...
    <div className="p-6 md:p-8 w-full animate-fade-in">
      ...
      <div className="flex items-start justify-between mb-8 flex-wrap gap-4">
        <div>
          ...
          <p className="text-sm mt-1" style={{ color: "var(--text-muted)" }}>
            ...
            {role && (
              <span
                className={`ml-2 badge ${role === "admin" ? "role-admin" : role === "approver" ? "role-approver" : "role-employee"}`}
              >
                {ROLE_LABELS[role]}
              </span>
            )}
      ...
      <div className="grid lg:grid-cols-3 gap-6">
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <p
                        ...
                        style={{ color: "var(--text-base)" }}
                      >
                        {format(parseISO(r.from), "dd.MM.", { locale: de })} –{" "}
                ...
                return (
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <span className={`badge ${cfg.color} text-[10px]`}>
                        {cfg.label}
                      </span>
                      <span
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="card p-5 animate-fade-in-d3">
            ...
            <div className="flex flex-col gap-2">
              ...
              {canApprove(role) && isAdminView && (
                <Link
                  href="/dashboard/requests?filter=pending"
                  className="btn-secondary w-full justify-center"
                  style={{
              ...
              {upcoming.slice(0, 2).map((r) => (
                <div key={r.id} className="mb-3 last:mb-0">
                  ...
                  <p
                    ...
                    style={{ color: "var(--text-base)" }}
                  >
                    {format(parseISO(r.from), "dd. MMMM", { locale: de })} –{" "}
                    {format(parseISO(r.to), "dd. MMMM yyyy", { locale: de })}
                  </p>
                  {r.reason && (
                    <p
          ...
          {role === "admin" && isAdminView && (
            <div
              className="card p-5 animate-fade-in-d5"
