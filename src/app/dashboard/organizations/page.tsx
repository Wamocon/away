  ...
  const loadOrgs = useCallback(async (uid: string) => {
    ...
    await Promise.all(
      filtered.map(async (org) => {
        try {
          roleMap[org.id] = await getUserRole(uid, org.id);
        } catch {
          roleMap[org.id] = "user";
        }
      }),
    ...
    <div className="p-6 w-full animate-fade-in">
      <div className="mb-6 flex items-center justify-between">
        <div>
          ...
          <p className="text-sm dark:text-white/40 text-gray-500 mt-1">
            Verwalte deine Organisationen und lade Mitarbeiter ein
          </p>
        </div>
      ...
      {orgs.length === 0 ? (
        ...
        >
          <Building2
            size={32}
            className="mx-auto mb-3 dark:text-white/20 text-gray-300"
          />
            ...
            return (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-semibold dark:text-white text-gray-800 truncate">
                    {org.name}
                  </p>
          ...
          {orgs.map((org) => {
            ...
            return (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-base font-bold dark:text-white text-gray-900 truncate">
                    {org.name}
                  </p>
            ...
            {roles[selectedOrg.id] === "admin" ? (
              <>
                <div className="flex flex-wrap gap-2">
                  <button
                    onClick={() => {
                      setUploadingOrgId(selectedOrg.id);
                      setSelectedOrg(null);
                    }}
              ...
              <p className="text-sm" style={{ color: "var(--text-muted)" }}>
                Du bist Mitglied dieser Organisation.
              </p>
            )}
          </div>
        </Modal>
