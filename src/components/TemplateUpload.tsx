      ...
      <div className="space-y-6 py-2">
        {!success ? (
          <>
            ...
            >
              <div
                className={`w-16 h-16 rounded-[20px] flex items-center justify-center mb-5 transition-all duration-500 ${
                  file
          ...
          <div className="py-12 text-center animate-in zoom-in-95 duration-700">
            ...
            <p className="text-[11px] uppercase font-black tracking-widest mt-2 opacity-40 text-white">
              Die Vorlage steht nun bereit
            </p>
          </div>
        )}
      </div>
