  ...
  return (
    <LegalPageShell title="Allgemeine Geschäftsbedingungen" updatedAt="März 2026">
      ...
      <LegalSection title="§ 7 Gewährleistung und Mängelbeseitigung">
        ...
        <p>(2) Mängel hat der Auftraggeber unverzüglich nach Entdeckung unter möglichst genauer Beschreibung schriftlich oder per E-Mail an <a className="font-medium text-[var(--primary)] hover:underline" href="mailto:info@wamocon.com">info@wamocon.com</a> zu melden.</p>
      ...
      <LegalSection title="§ 8 Haftung">
        ...
        <p>(5) Der Anbieter haftet nicht für die inhaltliche Richtigkeit von Benutzereingaben oder daraus abgeleiteten Auswertungen. Diese ersetzen keine fachliche Prüfung durch den Nutzer.</p>
      ...
      <LegalSection title="§ 10 Vertraulichkeit">
        ...
        <p>(2) Vom Auftraggeber hochgeladene Organisationsdaten, Dokumentationen und sonstige vertrauliche Inhalte werden ausschließlich für die vertragliche Leistungserbringung verwendet.</p>
        <p>(3) Die Vertraulichkeitspflicht gilt über die Beendigung des Vertragsverhältnisses hinaus für einen Zeitraum von zwei (2) Jahren, soweit keine weitergehenden gesetzlichen Pflichten bestehen.</p>
      </LegalSection>
