...
function InviteContent() {
  ...
  const [status, setStatus] = useState<
    "loading" | "ready" | "joining" | "success" | "error" | "invalid"
  >("loading");
        ...
        <div className="bg-white/[0.03] border border-white/10 rounded-3xl p-8 backdrop-blur-xl shadow-2xl">
            ...
            <div className="py-8 flex flex-col items-center gap-4 text-center">
              ...
              <div>
                ...
                <p className="text-white/40 text-xs mt-1 leading-relaxed">
                  Der Link ist leider abgelaufen oder die Organisation existiert
                  nicht mehr.
                </p>
              </div>
            </div>
          ...
          {status === "error" && (
            <div className="py-8 flex flex-col items-center gap-6 text-center">
              ...
              <p className="text-red-400 text-sm font-medium max-w-[200px] leading-relaxed">
                {message}
              </p>
              <button
                onClick={() => setStatus("ready")}
                className="text-xs text-white/40 hover:text-white/60 font-bold border-b border-white/5 pb-1"
              >
                Erneut versuchen
              </button>
            </div>
