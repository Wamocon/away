  ...
  return (
    <LegalPageShell title="Datenschutzerklärung" updatedAt="März 2026">
      ...
      <LegalSection title="2. Überblick über die Datenverarbeitung">
        <p>
          Diese Datenschutzerklärung gilt für die Website und Webanwendung AWAY.
          AWAY ist eine digitale Plattform für professionelles
        ...
        <p>
          ...
          Einwilligung des Nutzers oder auf einer anderen gesetzlichen
          Grundlage.
        </p>
      </LegalSection>
      ...
      <LegalSection title="4. Hosting und Infrastruktur">
        <p>
          Unsere Plattform wird über moderne Cloud-Infrastruktur bereitgestellt.
        ...
        <div className="space-y-4">
          <div>
            ...
            <p>
              Die Website und Webanwendung werden über Vercel gehostet. Dabei
              verarbeitet Vercel technisch notwendige Verbindungsdaten wie
              IP-Adresse, Zeitstempel und Browserinformationen. Rechtsgrundlage
          ...
          <div>
            ...
            <p>
              Für Datenbank, Authentifizierung, Dateispeicher und Teile der
              Backend-Infrastruktur nutzen wir Supabase (bevorzugt in den
              Regionen der EU). Verarbeitet werden insbesondere
              Authentifizierungsdaten, Session-Informationen, Projektdaten sowie
              gespeicherte Medien. Rechtsgrundlage ist Art. 6 Abs. 1 lit. b
              DSGVO.
            </p>
          </div>
          <div>
            ...
            <p>
              Für den Versand von Einladungs-E-Mails und
              Systembenachrichtigungen nutzen wir Resend. Verarbeitet werden
              dabei insbesondere E-Mail-Adresse, Organisationsbezug und der
              Nachrichteninhalt. Rechtsgrundlage ist Art. 6 Abs. 1 lit. b DSGVO.
            </p>
          </div>
        </div>
      </LegalSection>
      ...
      <LegalSection title="5. Registrierung und Authentifizierung">
        <p>
          Für die Nutzung von AWAY ist eine Registrierung erforderlich. Bei der
          Registrierung und Kontonutzung werden insbesondere folgende Daten
          verarbeitet:
        </p>
        <ul className="list-disc space-y-1 pl-5 text-sm leading-relaxed text-[var(--text-muted)]">
          ...
          <li>
            Rolle innerhalb einer Organisation (z. B. Admin, Manager, User)
          </li>
          <li>
            Session-Tokens und sicherheitsrelevante
            Authentifizierungsinformationen
          </li>
        </ul>
        <p>
          Die Authentifizierung erfolgt über Supabase Auth. Die Verarbeitung
          dient der Vertragserfüllung gemäß Art. 6 Abs. 1 lit. b DSGVO.
        </p>
      </LegalSection>

      <LegalSection title="6. Datenverarbeitung auf der Plattform">
        <p>
          Im Rahmen der Nutzung von AWAY werden insbesondere folgende Kategorien
          personenbezogener und organisationsbezogener Daten verarbeitet:
        </p>
        <ul className="list-disc space-y-1 pl-5 text-sm leading-relaxed text-[var(--text-muted)]">
          <li>Organisations- und Teamdaten</li>
          <li>
            Urlaubs- und Abwesenheitsdaten (Titel, Zeitraum, Grund, Status)
          </li>
        ...
        <p>
          Diese Daten werden zur Durchführung des Vertrags, zur Teamkoordination
          und zur Dokumentation von Abwesenheiten verarbeitet. Rechtsgrundlage
      ...
      <LegalSection title="7. Cookies und lokale Speicherung">
        <p>
          AWAY verwendet technisch notwendige Cookies und ähnliche Technologien,
          soweit dies für Anmeldung, Sitzungsverwaltung, Sicherheit und den
          Betrieb der Plattform erforderlich ist.
        </p>
        <p>
          Zusätzlich nutzt die Plattform lokale Browser-Speichertechnologien wie
          localStorage und Gerätespeicher, um Spracheinstellungen und den
          Synchronisationszustand lokal zu speichern.
        </p>
        <p>
          Tracking-, Werbe- oder Analyse-Cookies werden derzeit nicht
          eingesetzt.
        </p>
      </LegalSection>
      ...
      <LegalSection title="8. Kontaktaufnahme">
        <p>
          ...
          mitgeteilten Daten wie Name, E-Mail-Adresse und Nachrichteninhalt
          verarbeitet, um Ihre Anfrage zu bearbeiten und für Anschlussfragen
          bereitzuhalten. Rechtsgrundlage ist Art. 6 Abs. 1 lit. f DSGVO.
        </p>
      </LegalSection>

      <LegalSection title="9. SSL- bzw. TLS-Verschlüsselung">
        <p>
          Diese Webanwendung nutzt aus Sicherheitsgründen eine SSL- bzw.
          TLS-Verschlüsselung. Eine verschlüsselte Verbindung erkennen Sie an
          der sicheren Browserverbindung über https.
        </p>
      </LegalSection>
      ...
      <LegalSection title="10. Weitergabe von Daten an Dritte">
        <p>
          ...
          grundsätzlich nur statt, wenn Sie Ihre ausdrückliche Einwilligung
          erteilt haben (Art. 6 Abs. 1 lit. a DSGVO), die Weitergabe zur
          Vertragserfüllung erforderlich ist (Art. 6 Abs. 1 lit. b DSGVO) oder
          eine rechtliche Verpflichtung besteht (Art. 6 Abs. 1 lit. c DSGVO).
        </p>
        <p>
          Im Rahmen der Auftragsverarbeitung setzen wir insbesondere Vercel,
          Supabase und Resend ein.
        </p>
      </LegalSection>
      ...
      <LegalSection title="11. Speicherdauer und Datenlöschung">
        <p>
          ...
          Aufbewahrungspflichten bestehen. Kontodaten werden mit Löschung des
          Benutzerkontos entfernt, sofern keine gesetzlichen Pflichten
          entgegenstehen.
        </p>
      </LegalSection>
      ...
      <LegalSection title="12. Rechte der betroffenen Personen">
        <p>
          Ihnen stehen als betroffene Person die Rechte auf Auskunft (Art. 15
          DSGVO), Berichtigung (Art. 16 DSGVO), Löschung (Art. 17 DSGVO),
          Einschränkung der Verarbeitung (Art. 18 DSGVO), Datenübertragbarkeit
          (Art. 20 DSGVO) sowie das Recht auf Widerspruch (Art. 21 DSGVO) und
          Widerruf einer Einwilligung (Art. 7 Abs. 3 DSGVO) zu.
        </p>
      </LegalSection>
      ...
      <LegalSection title="14. Änderungen dieser Datenschutzerklärung">
        <p>
          ...
          stets den aktuellen rechtlichen Anforderungen anzupassen. Für Ihren
