...
/**
 * Wiederverwendbares Subscription-Management-Panel für Super-Admins.
 * Enthält keinen eigenen Auth-Check – der Eltern-Context muss sicherstellen,
 * dass der Nutzer ein Super-Admin ist.
 */
export default function SuperAdminSubscriptionsPanel() {
