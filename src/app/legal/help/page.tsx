...
const helpTopics = [
  {
    ...
    title: "Schnellstart",
    description:
      "Erste Schritte mit AWAY – von der Registrierung bis zum ersten Urlaubsantrag.",
    steps: [
  ...
  },
  {
    ...
    description:
      "Einfacher Antrag oder detaillierter Wizard-Antrag mit Dokument-Export.",
    steps: [
  ...
  },
  {
    ...
    description:
      "Google- oder Microsoft-Konto verbinden, um E-Mails im eigenen Namen zu versenden.",
    steps: [
...
const troubleshooting = [
  {
    ...
    solution:
      "Prüfe ob ein E-Mail-Konto unter Einstellungen → E-Mail verbunden ist. Ohne E-Mail-Verbindung kann keine Benachrichtigung versendet werden.",
  },
  {
    problem: "Feiertage werden falsch berechnet",
    solution:
      "Das Bundesland für die Feiertagsberechnung wird unter Admin → Einstellungen → Organisation konfiguriert. Bitte deinen Administrator, das richtige Bundesland einzustellen.",
  },
  {
    problem: "Kalender-Synchronisation schlägt fehl",
    solution:
      "Entferne die bestehende Verbindung unter Einstellungen → E-Mail und verbinde das Konto erneut. Stelle sicher, dass du den Kalender-Zugriff beim OAuth-Popup erlaubst.",
  },
  {
    problem: "Kein Zugriff auf Admin-Bereich",
    solution:
      'Nur Nutzer mit der Rolle "Admin" können den Admin-Bereich aufrufen. Bitte deinen Organisationsadministrator, deine Rolle anzupassen.',
  },
  {
    problem: "Login funktioniert nicht",
    solution:
      'Versuche, das Passwort zurückzusetzen über "Passwort vergessen" auf der Login-Seite. Prüfe auch, ob die E-Mail-Adresse korrekt ist.',
  },
];
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p
              ...
              style={{ color: "var(--text-muted)" }}
            >
              WAMOCON GmbH · E-Mail: support@wamocon.de
              <br />
