  ...
  return (
    <LegalPageShell title="Impressum" updatedAt="März 2026">
      ...
      <LegalSection title="Angaben zum Angebot">
        <p className="mt-4 text-sm leading-relaxed text-[var(--text-muted)]">
          AWAY ist eine webbasierte Software-as-a-Service-Plattform für
          professionelles Urlaubsmanagement, Abwesenheitsplanung und
          Teamkoordination. Das Angebot richtet sich primär an Unternehmen,
